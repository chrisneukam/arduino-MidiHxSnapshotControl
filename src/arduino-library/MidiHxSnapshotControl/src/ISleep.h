 ...
 * @brief Definition of the midihxsnapshotcontrol::ISleep interface.
 * @version 1.0
 * @date 2024-07-14
 *
 * @copyright Copyright 2024 Christian Neukam. All rights reserved.
 * @note Code copied from
 * https://github.com/chrisneukam/MidiDmxBridge/blob/main/src/ISleep.h .
 *
 ...
 */
#ifndef __MIDIHXSNAPSHOTCONTROL_I_SLEEP_H__
#define __MIDIHXSNAPSHOTCONTROL_I_SLEEP_H__
