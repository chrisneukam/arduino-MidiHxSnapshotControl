 ...
 * @brief Utilities of the midihxsnapshotcontrol library.
 * @version 1.0
 * @date 2024-07-14
 *
 * @copyright Copyright 2024 Christian Neukam. All rights reserved.
 * @note Code copied from
 * https://github.com/chrisneukam/MidiDmxBridge/blob/main/src/midi_dmx/vector.h .
 *
 ...
 */
#ifndef __MIDIHXSNAPSHOTCONTROL_VECTOR_H__
#define __MIDIHXSNAPSHOTCONTROL_VECTOR_H__
