 ...
 * @brief Mock definition of the midihxsnapshotcontrol::ISerialReader interface
 * @version 1.0
 * @date 2024-07-14
 *
...
namespace midihxsnapshotcontrol::unittest {
/**
 * @brief This class provides the mock implementation of the midihxsnapshotcontrol::ISerialReader
 * interface.
 *
 */
class SerialReaderMock : public midihxsnapshotcontrol::ISerialReader {
 public:
  /**
  ...
  /**
   * @brief Mock methods from midihxsnapshotcontrol::ISerialReader.
   *
   */
  ///@{
